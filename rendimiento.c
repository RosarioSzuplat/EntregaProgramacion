...
int main (void)
{
float km,precio,totalpesos,rendimiento, rendimientomin = 999999999999999, rendimientomax = 0, rendimientotot = 0, kmtot = 0, combustibletot = 0, costotot = 0, promedio;
int x,y,z, ingresos = 0;
char c; /* declaracion de variables */

while (1) /* ciclo que se cumple siempre */
{
...
if (rendimiento > rendimientomax) /* rendimientos max y min*/
